                                ...
                                <tr>
                                    ...
                                    foreach ($ticketsDay as $row) {
                                        if ($row['venue'] == 'All Access') {
                                            ?>
                                            <div class="allAccesTicketcontainer">
                                                <div class="allAccesTicketblock"></div>
                                                <img class="ticketImg"
                                                     src="../public/images/tickets/<?php echo $row['img'] ?>">
                                                ...
                                                <form class="ticketForm"
                                                    ...
                                                    <input class="inputTicketForm" type="text" name="amount"
                                                           placeholder="Amount"><br>
                                                    <input class="submitTicketForm" type="submit" name="add"
                                                           value="Add to cart">
                                                </form>
                                            </div>
                                            <?php
